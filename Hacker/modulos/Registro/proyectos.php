...
$recorrer=$vistadeProyectos->ValidarRegistroUsuario();
...
$tabla=""; 
 ...
 foreach ($ver as $key) {
		 ...
		 $solicitar='<button class=\"btn btn-success\" data-toggle=\"modal\" onclick=\"Registrar('."'".$_SESSION["idUser"]."','".$key['7']."'".')\">Participar</button>';           
